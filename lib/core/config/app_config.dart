abstract final class AppConfig {
  ...
  static const String version = 'v0.13.0';
  static const String stage = '段階 3-4B';

  static const int driveSpikeMaxPhotoBytes = 2 * 1024 * 1024;

  // 正式な記録画面で選択する写真の初期設定。
  static const int recordImageMaxDimension = 2000;
  static const int recordImageQuality = 80;
